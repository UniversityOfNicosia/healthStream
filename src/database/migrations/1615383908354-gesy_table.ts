...
export class gesyTable1615383908354 implements MigrationInterface {
    name = 'gesyTable1615383908354'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `lab_activity` (`id` int NOT NULL AUTO_INCREMENT, `sequenceNumber` int NOT NULL, `code` varchar(255) NOT NULL, `type` enum ('PANEL', 'TEST') NOT NULL, `name` varchar(255) NOT NULL, `labTestComments` varchar(255) NULL, `labTestResultsRequired` tinyint NOT NULL, `sampleTypeName` varchar(255) NULL, `laboratoryId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `lab_beneficiary` (`id` int NOT NULL AUTO_INCREMENT, `beneficiaryId` varchar(255) NOT NULL, `beneficiaryDocType` varchar(255) NOT NULL, `beneficiaryName` varchar(255) NOT NULL, `beneficiaryLastName` varchar(255) NOT NULL, `beneficiaryGender` enum ('M', 'F', 'O') NOT NULL, `beneficiaryDOB` datetime NOT NULL, `laboratoryId` int NULL, UNIQUE INDEX `REL_86b2e21b8a56318299dffc026f` (`laboratoryId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
